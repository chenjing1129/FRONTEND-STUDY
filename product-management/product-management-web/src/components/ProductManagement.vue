    ...
    <div>
        ...
        <el-dialog v-model="isDialogOpen" title="商品信息">
            <el-form :model="form">
                ...
                <el-upload action="http://localhost:8080/api/products/upload" list-type="picture-card" :on-success="handleUploadSuccess" :file-list="fileList" :limit="1" accept="image/*">
